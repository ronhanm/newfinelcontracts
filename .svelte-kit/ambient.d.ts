...
declare module '$env/static/private' {
	...
	export const POCKET_IC_SERVER_VERSION: string;
	...
	export const POCKET_IC_PYTHON_VERSION: string;
	...
	export const CANISTER_ID_ETH_CKETH_BRIDGE_FRONTEND: string;
	export const CANISTER_ID_ETH_CKETH_BRIDGE_BACKEND: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PATH: string;
		POCKET_IC_SERVER_VERSION: string;
		NODE: string;
		...
		POCKET_IC_PYTHON_VERSION: string;
		...
		EDITOR: string;
		NODE_ENV: string;
		CANISTER_ID_ETH_CKETH_BRIDGE_FRONTEND: string;
		CANISTER_ID_ETH_CKETH_BRIDGE_BACKEND: string;
